...
- 項目に欠落がある場合、当該項目を""(空文字)で補完し、エラーとしてログに記載せよ。
...
「備考」欄の記載は自動レビューやPrisma変換に直接寄与しないため、取得不要である。また、上記4項目に欠落がある場合、エラーとしてログに記録せよ。
...
- 項目に欠落がある場合、当該項目を""(空文字)で補完し、エラーとしてログに記載せよ。
- 上記の書式変換に当てはまらない場合、記載のまま出力し、警告としてログに記載せよ。
